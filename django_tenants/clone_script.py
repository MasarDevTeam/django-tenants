...
ClONE_END = f"ALTER FUNCTION public.clone_schema(text, text, boolean, boolean, boolean) OWNER TO {db_user};"
...
ALTER FUNCTION public.clone_schema(text, text, boolean, boolean, boolean) OWNER TO {db_user};
"""
